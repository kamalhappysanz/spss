        ...
        <div class="content-wrapper">
          ...
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-custom">
              ...
              <li class="breadcrumb-item active" aria-current="page"><span>View Student union</span></li>
            </ol>
          </nav>
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card" id="list">
              ...
              <?php  }  ?>
                ...
                <div class="card-body"  >
                  <h4 class="card-title">List of Student Union</h4>
      ...
      <thead >
        ...
        <?php $i=1; foreach($res as $rows){ ?>
          <tr id="<?php echo $rows->id; ?>">
            ...
            <?php   } ?></td>
            <td><a href="<?php echo base_url(); ?>adminexam/get_modules_edit/<?php echo base64_encode($rows->id*98765); ?>"><i class="fa fa-edit"></i></a> &nbsp;&nbsp;
            </td>
          </tr>
        <?php  $i++;  }  ?>
      </tbody>
