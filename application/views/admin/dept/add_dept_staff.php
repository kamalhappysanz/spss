        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Create Department Staff</h4>
        ...
        <?php $i=1; foreach($res as $rows){ ?>
          <tr id="<?php echo $rows->id; ?>">
            ...
            <td><a title="Update" href="<?php echo base_url(); ?>admindept/get_dept_edit/<?php echo base64_encode($rows->id*98765); ?>"><i class="fa fa-edit"></i></a> &nbsp;&nbsp;
              <a title="Add Staff" href="<?php echo base_url(); ?>admindept/add_dept_staff/<?php echo base64_encode($rows->id*98765); ?>"><i class="fa fa-user" aria-hidden="true"></i></a> &nbsp;&nbsp;
