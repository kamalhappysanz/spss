          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card" id="list">
              ...
              <?php  }  ?>
                ...
                <div class="card-body"  >
                  <h4 class="card-title">List of Department Syllabus <a href="javascript:window.history.go(-1);" class="btn go_back_btn pull-right">Back</a></h4>
...
function updateOrder(data) {
    $.ajax({
        url:"<?php echo base_url(); ?>admindept/change_dept_syllabus_position",
        type:'post',
        data:{position:data},
