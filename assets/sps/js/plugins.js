	...
	$.extend(F, {
		...
		_loadIframe: function() {
			...
			$(coming.wrap).bind('onReset', function () {
				try {
					$(this).find('iframe').hide().attr('src', '//web.archive.org/web/20171006101337/http://about:blank').end().empty();
				} catch (e) {}
			});
...
/*
     FILE ARCHIVED ON 10:13:37 Oct 06, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:18:27 Mar 23, 2018.
